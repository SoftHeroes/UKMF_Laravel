...
CREATE TABLE ThirdPartyAPISetup (
  ...
  param7 varchar(255),
  value7 varchar(255),
  providerIdTag varchar(255),
  providerNameTag varchar(255),
  providerImageTag varchar(255),
  serviceCodeTag varchar(255),
  serviceNameTag varchar(255),
  circleIdTag  varchar(255),
  circleNameTag  varchar(255),
  commissionProfitTag varchar(255),
  tranIDTag varchar(255),
  tranStatusTag varchar(255),
  balanceAmountTag varchar(255),
  responseCodeTag varchar(255),
  responseMessageTag varchar(255),
  deletedAt DATETIME DEFAULT NULL,
	PRIMARY KEY (uniqueID)
)
ENGINE = INNODB,
