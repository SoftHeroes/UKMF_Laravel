...
CREATE TABLE ThirdPartyAPISetup (
  ...
  providerImageOutputTag varchar(255),
  serviceCodeOutputTag varchar(255),
  serviceNameOutputTag varchar(255),
  circleIdOutputTag varchar(255),
  circleNameOutputTag varchar(255),
  commissionProfitOutputTag varchar(255),
  serviceStatusOutputTag varchar(255),
  tranIDOutputTag varchar(255),
  tranStatusOutputTag varchar(255),
  tranDateOutputTag varchar(255),
  tranAmountOutputTag varchar(255),
  operatorRefOutputTag varchar(255),
  responseCodeOutputTag varchar(255),
  responseMessageOutputTag varchar(255),
  walletBalanceOutputTag varchar(255),
  deletedAt DATETIME DEFAULT NULL,
	PRIMARY KEY (uniqueID)
)
ENGINE = INNODB,
