      ...
      <div class="resetpass-box">
        <form class="login-form" action="{{URL::to('/resetPassword')}}" method="POST">
           ...
           <div class="form-group">
            ...
            <input class="form-control" name="newPassword" type="newPassword"  minlength=8 maxlength=16 placeholder="********" autofocus>
          </div>
          <div class="form-group">
            <label class="control-label">Confirm password</label>
            <input class="form-control" name="confirmPassword" type="confirmPassword" minlength=8 maxlength=16 placeholder="********">
          </div>
          <div class="form-group">
